 ...
 */
function scaffoldIdumbTree(directory) {
    const created = [];
...
// FORMAT OUTPUT
// ============================================================================
function formatScanOutput(result, createdDirs) {
    const lines = [];
...
export const idumb_init = tool({
    description: "Initialize iDumb intelligence layer. Scaffolds the .idumb/ directory tree, scans the codebase exhaustively (files, deps, stack, framework, gaps, debt, drift), and writes results to .idumb/brain/context/scan-result.json. Run this first after installing the plugin.",
    args: {
