 ...
 */
export function getAgentPermission(config, agentName) {
 ...
 */
export function isToolAllowed(permission, toolName) {
 ...
 */
export function mergeConfigs(global, project, plugin) {
    return ConfigSchema.parse({
        ...global,
        ...project,
        ...plugin,
